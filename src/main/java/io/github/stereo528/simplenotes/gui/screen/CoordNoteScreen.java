...
public class CoordNoteScreen extends BaseNoteScreen {
	...
	public void render(PoseStack poseStack, int mouseX, int mouseY, float delta) {
		...
		this.font.draw(poseStack, name, (int) ((this.width/2) - name.toString().length()), this.height/2 - 36, 16777215);
		this.font.draw(poseStack, desc, (int) ((this.width/2) - desc.toString().length()), this.height/2, 16777215);
